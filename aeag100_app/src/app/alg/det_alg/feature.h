...
void getFreqSpan(struct DroneLib *droneLib, int nLibElem, float cenFreq, float dF, int fInvNhalf, int *vidIndex, int *ctrIndex);
void printUavlib(struct DroneLib *droneLib, int nLibElem);
