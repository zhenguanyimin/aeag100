...
#define AD9363_SPI_RE 0x10 //bit0 @0x10,read enable 
#define AD9363_SPI_WE 0x10 //bit1 @0x10,write enable 
#define AD9363_SPI_RW_ADDR 0x11 //bit0-bit9,read and write  addr
#define AD9363_SPI_WDATA 0x12 //bit0-bit7,write data regaddr
#define AD9363_SPI_RDATA 0x90 //[s_ad_spi_result,s_ad_spi_rdata];s_ad_spi_result,8bits;s_ad_spi_rdata;8bits,s_ad_spi_rdata is value when s_ad_spi_result=1;
...
#define AD936X_CTR_ADDR 	0x20	//txnrx -bit0;enable -bit1; enagc -bit2; reset -bit3;
