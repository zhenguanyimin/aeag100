...
void Ad9361Config_tx_01(void)
{
	...
	u8 Ad9361Config[][3] = {
		...
		{0x80, 0x46, 0x03}, // SPIWrite	046,03	// Set BBPLL Loop Filter Charge Pump current
		...
		{0x80, 0x43, 0x29}, // SPIWrite	043,29	// BBPLL Freq Word (Fractional[7:0])
		{0x80, 0x42, 0x5C}, // SPIWrite	042,5C	// BBPLL Freq Word (Fractional[15:8])
		{0x80, 0x41, 0x12}, // SPIWrite	041,12	// BBPLL Freq Word (Fractional[23:16])
		{0x80, 0x44, 0x18}, // SPIWrite	044,18	// BBPLL Freq Word (Integer[7:0])
		...
		{0x80, 0x02, 0xD2}, // SPIWrite	002,D2	// Setup Tx Digital Filters/ Channels
		{0x80, 0x03, 0x1A}, // SPIWrite	003,DA	// Setup Rx Digital Filters/ Channels
		...
		//************************************************************
		// Program Tx FIR: C:\Users\HJX\Desktop\CONFIG\CONFIG2\test.txt
		//************************************************************
		{0x80, 0x65, 0x7A}, // SPIWrite	065,7A	// Enable clock to Tx FIR Filter and set Filter gain Setting
		{0x80, 0x60, 0x00}, // SPIWrite	060,00	// Write FIR coefficient address
		{0x80, 0x61, 0x00}, // SPIWrite	061,00	// Write FIR coefficient data[7:0]
		{0x80, 0x62, 0x00}, // SPIWrite	062,00	// Write FIR coefficient data[15:8]
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E	// Set Write EN to push data into FIR filter register map
		...
		{0x80, 0x61, 0x18}, // SPIWrite	061,18
		{0x80, 0x62, 0x04}, // SPIWrite	062,04
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x60, 0x14}, // SPIWrite	060,14
		{0x80, 0x61, 0x2D}, // SPIWrite	061,2D
		{0x80, 0x62, 0x00}, // SPIWrite	062,00
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x60, 0x15}, // SPIWrite	060,15
		{0x80, 0x61, 0x6A}, // SPIWrite	061,6A
		...
		{0x80, 0x62, 0x09}, // SPIWrite	062,09
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x60, 0x19}, // SPIWrite	060,19
		{0x80, 0x61, 0x12}, // SPIWrite	061,12
		{0x80, 0x62, 0x0A}, // SPIWrite	062,0A
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x60, 0x1A}, // SPIWrite	060,1A
		{0x80, 0x61, 0x5C}, // SPIWrite	061,5C
		{0x80, 0x62, 0xFD}, // SPIWrite	062,FD
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x60, 0x1B}, // SPIWrite	060,1B
		{0x80, 0x61, 0xEC}, // SPIWrite	061,EC
		{0x80, 0x62, 0xED}, // SPIWrite	062,ED
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		...
		{0x80, 0x62, 0x37}, // SPIWrite	062,37
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x60, 0x1F}, // SPIWrite	060,1F
		{0x80, 0x61, 0xCB}, // SPIWrite	061,CB
		{0x80, 0x62, 0x58}, // SPIWrite	062,58
		{0x80, 0x65, 0x7E}, // SPIWrite	065,7E
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		...
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x64, 0x00}, // SPIWrite	064,00
		{0x80, 0x65, 0x78}, // SPIWrite	065,78	// Disable clock to Tx Filter

		//************************************************************
		// Program Rx FIR: C:\Users\HJX\Desktop\CONFIG\CONFIG2\test.txt
		//************************************************************
		{0x80, 0xF5, 0x7A}, // SPIWrite	0F5,7A	// Enable clock to Rx FIR Filter
		{0x80, 0xF6, 0x01}, // SPIWrite	0F6,01	// Write Filter Gain setting
		{0x80, 0xF0, 0x00}, // SPIWrite	0F0,00	// Write FIR coefficient address
		{0x80, 0xF1, 0xFF}, // SPIWrite	0F1,FF	// Write FIR coefficient data[7:0]
		{0x80, 0xF2, 0xFF}, // SPIWrite	0F2,FF	// Write FIR coefficient data[15:8]
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E	// Set Write EN to push data into FIR filter register map
		...
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		...
		{0x80, 0xF1, 0xE4}, // SPIWrite	0F1,E4
		{0x80, 0xF2, 0xFF}, // SPIWrite	0F2,FF
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		...
		{0x80, 0xF1, 0x0C}, // SPIWrite	0F1,0C
		{0x80, 0xF2, 0x00}, // SPIWrite	0F2,00
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF0, 0x07}, // SPIWrite	0F0,07
		{0x80, 0xF1, 0x3F}, // SPIWrite	0F1,3F
		{0x80, 0xF2, 0x00}, // SPIWrite	0F2,00
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		...
		{0x80, 0xF1, 0xDA}, // SPIWrite	0F1,DA
		{0x80, 0xF2, 0xFF}, // SPIWrite	0F2,FF
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
	};
...
void Ad9361Config_tx_02(void)
{
	...
	u8 Ad9361Config[][3] = {
		...
		{0x80, 0xF1, 0x84}, // SPIWrite	0F1,84
		{0x80, 0xF2, 0xFF}, // SPIWrite	0F2,FF
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		...
		{0x80, 0xF1, 0x5D}, // SPIWrite	0F1,5D
		{0x80, 0xF2, 0x00}, // SPIWrite	0F2,00
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF0, 0x0D}, // SPIWrite	0F0,0D
		{0x80, 0xF1, 0xDD}, // SPIWrite	0F1,DD
		{0x80, 0xF2, 0x00}, // SPIWrite	0F2,00
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF0, 0x0E}, // SPIWrite	0F0,0E
		{0x80, 0xF1, 0x6C}, // SPIWrite	0F1,6C
		{0x80, 0xF2, 0x00}, // SPIWrite	0F2,00
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF0, 0x0F}, // SPIWrite	0F0,0F
		{0x80, 0xF1, 0x3B}, // SPIWrite	0F1,3B
		{0x80, 0xF2, 0xFF}, // SPIWrite	0F2,FF
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		...
		{0x80, 0xF1, 0xB0}, // SPIWrite	0F1,B0
		...
		{0x80, 0xF1, 0xD0}, // SPIWrite	0F1,D0
		{0x80, 0xF2, 0xFE}, // SPIWrite	0F2,FE
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		...
		{0x80, 0xF2, 0x1B}, // SPIWrite	0F2,1B
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF0, 0x1F}, // SPIWrite	0F0,1F
		{0x80, 0xF1, 0x89}, // SPIWrite	0F1,89
		{0x80, 0xF2, 0x2C}, // SPIWrite	0F2,2C
		{0x80, 0xF5, 0x7E}, // SPIWrite	0F5,7E
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		...
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF4, 0x00}, // SPIWrite	0F4,00
		{0x80, 0xF5, 0x78}, // SPIWrite	0F5,78	// Disable clock to Rx Filter
		...
		{0x80, 0x07, 0x80}, // SPIWrite	007,80	// PPORT TX Delay (adjusts setup/hold FBCLK->Data)
		...
		{0x82, 0x82, 0x14}, // SPIWrite	282,14	// Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
		{0x82, 0x78, 0x78}, // SPIWrite	278,78	// Set VCO Cal Offset[3:0]
		...
		{0x82, 0x7B, 0x88}, // SPIWrite	27B,88	// Set Synth Loop Filter charge pump current (Icp)
		{0x82, 0x7E, 0xE6}, // SPIWrite	27E,E6	// Set Synth Loop Filter C2 and C1
		...
		{0x82, 0x73, 0x97}, // SPIWrite	273,00	// Write Tx Synth Fractional Freq Word[7:0]
		{0x82, 0x74, 0xCA}, // SPIWrite	274,00	// Write Tx Synth Fractional Freq Word[15:8]
		{0x82, 0x75, 0x6C}, // SPIWrite	275,00	// Write Tx Synth Fractional Freq Word[22:16]
		{0x82, 0x72, 0x00}, // SPIWrite	272,00	// Write Tx Synth Integer Freq Word[10:8]
		{0x82, 0x71, 0x4F}, // SPIWrite	271,8C	// Write Tx Synth Integer Freq Word[7:0] (starts VCO cal)
...
void Ad9361Config_tx_04(void)
{
	...
	u8 Ad9361Config[][3] = {
		...
		{0x81, 0x09, 0x3C}, // SPIWrite	109,22	// Rx1 Full/LMT Gain Index
		{0x81, 0x0A, 0x58}, // SPIWrite	10A,58	// Rx1 LPF Gain Index
		{0x81, 0x0B, 0x00}, // SPIWrite	10B,00	// Rx1 Digital Gain Index
		{0x81, 0x0C, 0x3C}, // SPIWrite	10C,22	// Rx2 Full/LMT Gain Index
		...
		{0x00, 0x16, 0x60}, // WAIT_CALDONE	TXFILTER,2000	// Wait for TX filter to tune, Max Cal Time: 1.444 us (Done when 0x016[6]==0)
		...
		{0x82, 0x08, 0x30}, // SPIWrite	208,30
		{0x82, 0x09, 0x34}, // SPIWrite	209,34
		{0x82, 0x0A, 0x41}, // SPIWrite	20A,41
		{0x82, 0x0B, 0x1E}, // SPIWrite	20B,1E
		{0x82, 0x0C, 0x43}, // SPIWrite	20C,43
		{0x82, 0x0D, 0x1C}, // SPIWrite	20D,1C
		...
		{0x82, 0x19, 0xB0}, // SPIWrite	219,B0
		{0x82, 0x1A, 0x31}, // SPIWrite	21A,31
		{0x82, 0x1B, 0x1C}, // SPIWrite	21B,1C
		{0x82, 0x1C, 0xB0}, // SPIWrite	21C,B0
		{0x82, 0x1D, 0x31}, // SPIWrite	21D,31
		{0x82, 0x1E, 0x1C}, // SPIWrite	21E,1C
		{0x82, 0x1F, 0xB0}, // SPIWrite	21F,B0
		{0x82, 0x20, 0x31}, // SPIWrite	220,31
		{0x82, 0x21, 0x37}, // SPIWrite	221,37
		{0x82, 0x22, 0x38}, // SPIWrite	222,38
		...
		{0x00, 0x16, 0x00}, // WAIT_CALDONE	BBDC,2000	// BBDC Max Cal Time: 3287.760 us. Cal done when 0x016[0]==0
		...
		//************************************************************
		{0x80, 0x73, 0x30}, // SPIWrite	073,00
		{0x80, 0x74, 0x00}, // SPIWrite	074,00
		{0x80, 0x75, 0x30}, // SPIWrite	075,00
		...
		{0x80, 0x14, 0x23}, // SPIWrite	014,23	// Power Measurement Duration
	};
	row = sizeof(Ad9361Config) / sizeof(Ad9361Config[0]);
	for (i = 0; i < row; i++)
	{
